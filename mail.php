...
<tr><td><nobr><b>Ваш e-mail*:</b></nobr></td><td align=right><input type=text name=mail_to maxlength=64 size=40></td></tr> 
<tr><td><nobr><b>Ваш телефон*:</b></nobr></td><td align=right><input type=text name=mail_tel maxlength=30 size=40 style='width:100%;'></td></tr> 
<tr><td colspan=2><b>Сообщение*:</b><br><textarea cols=50 rows=8 name=mail_msg></textarea><br>
</td> 
<tr><td colspan=2>Также вы можете воспользоваться вашей обычной почтой, например для отправки фотографий или других файлов - в этом случае пишите на <? echo $adminmail; ?></td></tr> 
</tr><tr><td colspan=2>
<center><input value="Отправить" type="button" onClick=" al=''; if (document.formsend.mail_subject.value=='') al = al + 'Вы не заполнили поле &quot;Ваши Ф.И.О.&quot;. '; if (document.formsend.mail_to.value=='') al = al + 'Вы не заполнили поле &quot;Ваш e-mail&quot;. '; if (document.formsend.mail_tel.value=='') al = al + 'Вы не заполнили поле &quot;Ваш телефон&quot;. '; if (document.formsend.mail_msg.value=='') al = al + 'Вы не заполнили поле &quot;Сообщение&quot;. '; if (al) alert(al); else submit();" style="width:180px; height: 50px;"></center>
</td></tr> 
</form> 
</table>Все поля обязательны к заполнению.
