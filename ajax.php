...
if ($func == "send_error") { // Отправка сообщения о найденной на сайте ошибке
	list($error, $comment) = explode("*@%", $string);
	system_mes("Посетителем сайта найдена предполагаемая ошибка:<br>
	Страница сайта: ".getenv("HTTP_REFERER")."<br>
	Ошибка: ".$error."<br>
	Комментарий: ".$comment);
	echo "Спасибо! Ваше сообщение принято и будет рассмотрено в ближайшее время.";
}///////////////////////////////////////////////////////////
