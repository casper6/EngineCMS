...
##########################################################################################
  ...
  if ($new_pages_send == "") $new_pages_send = "1";
  if ($ad_fon == "") $ad_fon = "1";
  ...
  // Настройки магазина
  if ($shop_text_ochistit == "") $shop_text_ochistit = ss("Очистить Корзину");
  ...
  if ($shop_text_delete_all == "") $shop_text_delete_all = ss("все");
