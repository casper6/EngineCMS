...
<li onmouseover=\"$('#logout_button').addClass('polosa_red');\" onmouseout=\"$('#logout_button').removeClass('polosa_red');\"><b>Выход из администрирования</b> — эту кнопку стоит нажимать после окончания всех работ по администрированию сайта только, если вы редактируете сайт за чужим компьютером или в интернет-кафе.</li>
