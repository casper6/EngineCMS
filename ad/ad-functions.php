...
function help_shablon() {
  ...
  return "<h2>Справка:</h2> <select class='w100' name=shablon_var2 onchange=\"$('#shablon_var').html(this.value); $('#shablon_var').show(); $('#show_shablon_var').show();\">
    ...
    [название папки] — Название папки (заголовок)<br>
    ...
    [предисловие_без_фото] – Из Предисловия страницы вырезаны все фотографии<br>
    [предисловие_без_html] – Из Предисловия страницы вырезаны все теги HTML, кроме списков (ul, ol, li)<br>
    [адрес фото] — Адрес первого фото в предисловии<br>
    [фото] — Первое фото в предисловии<br>
