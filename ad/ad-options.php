...
<table class='w100 mw800 pm0 block_back'><tr valign=top><td id='razdel_td' class='radius nothing'>
	...
	if ($show_admin_top != "2") echo "<div id='mainrazdel8' class='dark_pole2sel'><a class='base_page' onclick=\"options_show('8','show_first')\"><div id='mainrazdel".$id."'><span class='icon gray large' data-icon='.'></span><span class='plus20'>Начальные настройки</span></div></a></div>";
	if ($show_admin_top != "2") echo "<div id='mainrazdel1' class='dark_pole2'><a class='base_page' onclick=\"options_show('1','show_options_company')\"><div id='mainrazdel".$id."'><span class='icon gray large' data-icon='Y'></span><span class='plus20'>Карточка компании (мини блоки)</span></div></a></div>";
	if ($show_admin_top != "2") echo "<div id='mainrazdel3' class='dark_pole2'>";
	else echo "<div id='mainrazdel3' class='dark_pole2sel'>";
	echo "<a class='base_page' onclick=\"options_show('3','show_options_adspeed')\"><div id='mainrazdel".$id."'><span class='icon gray large' data-icon='z'></span><span class='plus20'>Администрирование</span></div></a></div>";
	...
	if ($show_admin_top != "2") echo "<div id='mainrazdel15' class='dark_pole2'>".select("options[show_comments]", "0,1", "НЕТ,ДА", $show_comments,'','right3')."<a class='base_page' onclick=\"options_show('15','show_options_comments')\"><div id='mainrazdel".$id."'><span class='icon gray large' data-icon=\"'\"></span><span class='plus20'>Комментарии</span> </div></a></div>";
	if ($show_admin_top != "2") echo "<div id='mainrazdel12' class='dark_pole2'><a class='base_page' onclick=\"options_show('12','show_options_fonts')\"><div id='mainrazdel".$id."'><span class='icon gray large' data-icon='i'></span><span class='plus20'>Шрифты</span></div></a></div>";
	if ($show_admin_top != "2") echo "<div id='mainrazdel13' class='dark_pole2'><a class='base_page' onclick=\"options_show('13','show_shop')\"><div id='mainrazdel".$id."'><span class='icon gray large' data-icon='$'></span><span class='plus20'>Магазин</span></div></a></div>";
	echo "<br>";
	...
	if ($show_admin_top != "2") echo "<div id='mainrazdel7' class='dark_pole2'><a class='base_page' onclick=\"options_show('7','show_options_oldfotos'); trash_pics(0,0,0);\"><div id='mainrazdel".$id."'><span class='icon gray large' data-icon='1'></span><span class='plus20'>Менеджер фотографий</span></div></a></div>";
	if ($show_admin_top != "2") echo "<div id='mainrazdel5' class='dark_pole2'><a class='base_page' href='sys.php?op=subscribe'><div id='mainrazdel".$id."'><span class='icon gray large' data-icon='@'></span><span class='plus20'>Cписок адресатов для рассылки</span></div></a></div>";
	if ($show_admin_top != "2") echo "<div id='mainrazdel6' class='dark_pole2'><a class='base_page' href='sys.php?op=users'><div id='mainrazdel".$id."'><span class='icon gray large' data-icon='U'></span><span class='plus20'>Пользователи (в разработке)</span></div></a></div>";
    if ($show_admin_top != "2") echo "<div id='mainrazdel11' class='dark_pole2'><a class='base_page' href='sys.php?op=txt_and_csv_main'><div id='mainrazdel".$id."'><span class='icon gray large' data-icon='('></span><span class='plus20'>Импорт из Excel (в формате .csv)</span></div></a></div>";
    if ($show_admin_top != "2") echo "<div id='mainrazdel11' class='dark_pole2'><a class='base_page' href='sys.php?op=parser_main'><div id='mainrazdel".$id."'><span class='icon gray large' data-icon='('></span><span class='plus20'>Парсер сайтов <sup>Beta</sup></span></div></a></div>";
	if ($show_admin_top != "2") echo "<div id='mainrazdel10' class='dark_pole2'><a class='base_page' onclick=\"options_show('10','show_options_razrab');\"><div id='mainrazdel".$id."'><span class='icon gray large' data-icon='b'></span><span class='plus20'>Информация для разработчиков</span></div></a></div>";
...
if ($show_admin_top != "2") echo "<div id='show_first' class='show_pole pl10'>";
else  echo "<div id='show_first' class='show_pole pl10' style='display:none;'>";

echo "<table class='table_light'>
<tr valign='top'><td style='min-width:250px;'>
<a href='http://ru.wikipedia.org/wiki/ЧПУ_(Интернет)' target='_blank'>ЧПУ</a></td><td class='small'>
".select("options[clean_urls]", "0,1,2", "ВЫКЛЮЧЕНО,транслит названия страницы (русско-английский),название страницы (только замена пробелов на «_» и спецсимволов)", $clean_urls)."
Человекопонятные ссылки в адресной строке браузера.
</td></tr>
...
&lt;script&gt;$(document).ready(function() { if ( document.getElementById('tovar') != null ) $('#sorter').show('slow'); });&lt;/script&gt;
	...
	<tr valign=top><td style='min-width:250px;'>
	Проверка орфографии и других ошибок текста пользователями сайта (улучшенный аналог <a href='http://orphus.ru' target='_blank'>Орфус</a>):</td><td class=small>
	".select("options[orfus]", "0,1", "НЕТ,ДА", $orfus)."Можно добавить в дизайн разъясняющее сообщение или баннер. Все баннеры сжатые и прозрычные, поэтому подойдут для любого дизайна. В данном случае баннер не ссылается ни на какие сайты и не содержит рекламы, применяется для информирования о возможностях сайта. Для использования баннера сохраните его картинку и вставьте на сайт или скопируйте его адрес (ссылку), нажав по нему правой кнопкой мыши и выбрав соответствующий пункт в меню. См. <a class='punkt' onclick=\"$('#orfus').toggle('slow');\">примеры</a><div id=orfus style='display:none;'>".close_button('orfus')."
<li>Нашли ошибку? Ctrl+Enter
<li>Ошибка в тексте? Выдели её мышкой и нажми Ctrl+Enter (или Cmd+Enter на Маке)
<li>Выделите ошибку и нажмите сочетание клавиш Ctrl+Enter
<li>Select spelling error with your mouse and press Ctrl+Enter
<li><img src='images/orfus1.png'>
<li><img src='images/orfus2.png'>
<li><img src='images/orfus3.png'>
<li><img src='images/orfus4.png'>
<li><img src='images/orfus5.png'>
<li><img src='images/orfus6.png'>
</div>
	</td></tr>
	...
	<b>+Продвижение:</b> Ссылка на страницу пользователя соц. сети Google+:</td><td class=small>
	".input("options[author]", $author, "100%")."
	<p>Ссылка на страницу публикаций (Posts). Используется для поискового продвижения в Гугле. Пример ссылки: https://plus.google.com/u/0/105731698421682755050/posts Инструкция:
	<li>зарегистрировать email на доменном имени сайта. Если сайт - abcd.ru, email - info@abcd.ru
	<li>зарегистрироваться в Google+ с этим email, поставить желательно реальное фото одного из сотрудников, написать его ФИО, в описании указать, что он работает в этой компании, указать профессию (Occupation), навыки (Skills), информацию о компании и контактах (Employment), отметить компанию на карте, добавить ссылки на все страницы сайта со статьями., на фон можно поставить фотографию фасада или офиса, логотип, продукцию или фото сотрудников.
	<li>открыть страницу Публикации (Posts), скопировать ее адрес (ссылку) и вставить сюда.
	<p>Сработает не сразу, необходимо время (до 2 недель) для обновления информации в Гугле. Если рядом с ссылками на сайт не появится фото сотрудника — значит скорее всего не сработало, тогда читайте <a href='https://support.google.com/webmasters/answer/1306778?hl=ru' target='_blank'>справку</a>.
	</td></tr><tr valign=top><td>
	...
	<tr valign=top class=p3><td>
	Простая защита от копирования (осторожно!): </td><td class=small>
	".select("options[stopcopy]", "0,1", "НЕТ,ЕСТЬ", $stopcopy)."Препятствует массовому копированию статей на чужие сайты глупыми злоумышленниками. Невозможность выделить/скопировать текст и нажать правую кнопку мыши. <b>При включении не работают визуальные редакторы для добавления комментариев и страниц.</b></td></tr>
	...
	<tr valign=top><td>
	Получать письма о добавленных страницах:</td><td class=small>
	".select("options[new_pages_send]", "0,1", "НЕТ,ДА", $new_pages_send)."Отправка уведомлений о новых страницах, добавленных посетителями, на почту администратора.
	</td></tr>
...
<p class=hide>Использование в шаблоне блоков [Купить_ссылка] и [Купить_кнопка] возможно только при подключении поля, которое содержит цену товара. В РАЗРАБОТКЕ!</p>
	...
	".input("options[shop_text_val1]", $shop_text_val1, 4)." ЧИСЛО ".input("options[shop_text_val2]", $shop_text_val2, 4)." 
	Пример: $ ЧИСЛО или ЧИСЛО руб.
	</td></tr><tr valign=top><td>
	Поле для автоматических блоков [Купить_ссылка] и [Купить_кнопка] (пока что не работает)</td><td class=small>
	".input("options[shop_pole]", $shop_pole, "100%")."<br>Блоки можно использовать в шаблонах.
	</td></tr><tr valign=top><td>
	Минимальная сумма заказа (число)</td><td class=small>
	".input("options[shop_minimal_itogo]", $shop_minimal_itogo, "10")." Если 0 — сообщение об этом не выводится.
	</td></tr><tr valign=top><td>
	Замена надписи «Минимальная сумма заказа — 10.000 руб.»</td><td class=small>
	".input("options[shop_minimal_itogo_text]", $shop_minimal_itogo_text, "100%")."
	</td></tr><tr valign=top><td>
	...
	Замена надписи «Очистить Корзину»:</td><td class=small>
	".input("options[shop_text_ochistit]", $shop_text_ochistit, "100%")."
	</td></tr><tr valign=top><td>
	Замена надписи на кнопке удаления всего количества товара «все»:</td><td class=small>
	".input("options[shop_text_delete_all]", $shop_text_delete_all, "100%")."
	</td></tr><tr valign=top><td colspan=2>
...
if ($show_admin_top != "2") echo "<div id='show_options_adspeed' class='show_pole pl10' style='display:none;'>";
else echo "<div id='show_options_adspeed' class='show_pole pl10'>";
...
if ($show_admin_top != "2") {
	...
	<tr valign=top><td>
	Режимы администрирования:</td><td class=small>
	".select("options[show_admin_top]", "0,1,2", "Скрыть верхнее меню,Стандартный режим,Только базы данных", $show_admin_top)."
	</td></tr>
	...
	<tr valign=top><td>
	Имя пользователя (логин)<br>и ключ (key) Яндекс:</td><td class=small>
	".input("options[yandex_user]", $yandex_user)."<br>".input("options[yandex_key]", $yandex_key)."<br>Используется при SEO-проверке страниц на уникальность, а также в парсере Яндекса. По-умолчанию Яндекс дает только 100 запросов в месяц и увеличить их количество можно только за счет своих популярных сайтов или перенаправления запросов от других пользователей. Также необходимо указать IP-адрес своего сайта ( <b>".$_SERVER['SERVER_ADDR']."</b> ) на странице настроек <a href='http://xml.yandex.ru/settings.xml' target='_blank'>Яндекс.XML</a>. На этой же странице можно узнать свой ключ — в поле «Ваш адрес для совершения запроса» копируйте всю оставшуюся строчку после &key=
	</td></tr>
