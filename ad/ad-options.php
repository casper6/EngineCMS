...
<div id='show_options' class='show_pole pl10' style='display:none;'>
	...
	".input("options[smile_icons]", $smile_icons, 30, "txt")."Для переопределения смайлов (если вы стерли какие-то смайлы или добавили свои в папку /images/smilies/) очистите эту строчку, сохраните настройки, затем сохраните еще раз.</td></tr>
