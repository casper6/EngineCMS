...
if ($realadmin==1) {
  ...
  function stat_main() {
    ...
    echo "<div class='black_grad'><span class='h1'>".aa("Статистика")."</span> <div class='right3' >";

    if ($statlink != "") echo "<a class='button right small' href=".$statlink." target='_blank'><span class=\"icon black small\" data-icon=\"j\"></span> Сторонняя статистика</a>";
