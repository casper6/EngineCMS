...
if ($realadmin==1) {
  ...
  function stat_main() {
    ...
    if ($numrows > 0) {
      ...
      <p>В средней колонке также выводится предполагаемое имя, email и телефон человека, искавшего этот запрос.<br>
      <p>В последней колонке: первое число - найдено в названии страниц, второе - в содержании.
