...
function base_pages_add_page($page_id=0, $red=0, $name=0, $razdel=0, $new=0, $pid=0) {
  ...
  echo "</td><td style='padding:0;'><a class='punkt' title='Свернуть/развернуть левую колонку' onclick='$(\"#razdels\").toggle(\"slow\");'><div class='w100' style='width:16px; height:500px; background: gray; cursor:url(\"images/cursor_split.png\"), pointer;'></div></a></td><td>";
