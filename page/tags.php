<?php
  ...
  $soderganie .= "<center><div class=main_search_line align=left><table border=0 cellspacing=1 cellpadding=0><tr><td><b>".ss("Вы выбрали тег")."</b> ".ss("(ключевое слово):")." <b>".$slov.".</b> ".ss("Найдено:")." ".$numrows."</td></tr></table></div><br><div class=main_search align=left><ol>
  ";
    if ($numrows!=0) {
