...
function login() {
	...
	echo "<!doctype html>\n<html lang=\"ru-RU\" dir=\"ltr\">\n<head><title>Вход в Администрирование</title><meta http-equiv='Content-Type' content='text/html; charset=utf-8'><meta http-equiv='pragma' content='no-cache' /><meta http-equiv='no-cache' /><meta http-equiv='cache-control' content='no-cache' /><link rel=\"stylesheet\" href=\"ad-style.css\" type=\"text/css\"><link REL=\"shortcut icon\" href=\"images/favicon_cms.png\" type=\"image/x-icon\"><script src='http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js'></script></head>\n<body style=\"background: url(images/adfon/23.png);\">\n<center style='margin-top:170px;'><form action='red' class=radius style=\"background: url(images/adfon/17.png); width:600px;-webkit-box-shadow:0px 0px 15px rgba(50, 50, 50, 0.6);-moz-box-shadow:0px 0px 15px rgba(50, 50, 50, 0.6);box-shadow:0px 0px 15px rgba(50, 50, 50, 0.6);\" method='post' id=form><h1>Вход в администрирование сайта</h1><br><table><tr><td align=right>Псевдоним: </td><td><input type=text name=aid size=20></td></tr><tr><td align=right>Пароль: </td><td><input type=password name=pwd size=20></td></tr><tr><td><input type=hidden name=password value='".$random."'><input type=hidden name=op value=login></td><td><input type=submit value=\" Войти \"></td></tr></table></form></center><script>$('#form').submit(function(e) {e.preventDefault();$('#form').animate({opacity: 0.1}, 2000,function(){ $('#form').unbind('submit').submit(); });});</script></body></html>";
}
