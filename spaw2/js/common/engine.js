...
{
  var posX = screen.availWidth/2 - 400;
  var posY = screen.availHeight/2 - 300;
  ...
  args.tbi = tbi;
  args.sender = sender;
  var wnd = window.open(durl, module + '_' + dialog, 'status=no,resizable=yes,width=800,height=600,left='+posX+',top='+posY);
