...
echo "<script type=\"text/javascript\" src=".SpawConfig::getStaticConfigValue('SPAW_DIR')."plugins/core/dialogs/table_prop.js></script>";
?>
...
<b>СОВЕТЫ:</b>
<li>Если в таблице нужно быстро добавить строки внизу - поставьте текстовый курсор на последнюю строку и нажмите <img align=bottom src=/spaw2/plugins/core/lib/theme/spaw2lite/img/tb_table_row_insert.gif>
<li>Хотите удалить таблицу - наведите на ее левый верхний угол до появления крестообразного курсора, выделите и нажмите Del. Если выделить не удалось - нажмите Shift + Tab для выделения, когда курсор стоит в одной из ячеек.