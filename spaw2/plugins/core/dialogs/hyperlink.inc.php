...
$spaw_hyperlink_styles = $config->getConfigValue("hyperlink_styles"); // added by 13i
...
<tr>
  ...
  <td align="left">
    ...
    <select name="ccssclass" id="ccssclass" size="1" class="input" onchange="SpawHyperlinkDialog.cssClassChanged();">
   <?php
   foreach($spaw_hyperlink_styles as $key => $text)
   {
