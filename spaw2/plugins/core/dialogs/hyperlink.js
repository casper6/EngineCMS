...
/* added by 13i */
if (aProps.className) {
      document.getElementById('ccssclass').value = aProps.className;
}
/* added by 13i */
...
SpawHyperlinkDialog.okClick = function() {
  ...
  if (!aProps.href || aProps.href == '' || aProps.href == window.location.href)
    ...
    /* added by 13i */
    aProps.className = (document.getElementById('ccssclass').value != 'default')?document.getElementById('ccssclass').value:'';
  if (!aProps.className || aProps.className == '')
    aProps.removeAttribute("class");
    /* added by 13i */
...
/* added by 13i */
SpawHyperlinkDialog.cssClassChanged = function()
{
}
/* added by 13i */
