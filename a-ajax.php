...
if ($func == "opengarbage") { // Открытие вкладок Содержания
  ...
  if ($id == 9) { // ПОМОЩЬ на стр. Редактирование раздела
    ...
    $pageslistdel .= "на Главной странице администрирования.<p><a class=h2 href=# onclick=\"$('#about_cms').show('slow');\">Что такое «ДвижОк»?</a>.
