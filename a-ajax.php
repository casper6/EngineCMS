...
if ($func == "opengarbage") { // Открытие вкладок Содержания
  ...
  if ($id == 10) {
    ...
    $pageslistdel .= "<p>Вы находитесь в Панели управления сайтом на Главной странице администрирования.<p><a class=h2 href=# onclick=\"$('#about_cms').show('slow');\">Что такое «ДвижОк»?</a>.
      ...
      <p><a class=h2 href=# onclick=\"$('#osnova').show('slow');\">Ознакомиться с основными элементами</a>.
...
<p><a class=h2 href=# onclick=\"$('#razdel').show('slow');\">Подробнее о разделах, папках и страницах</a>.
...
<p><a class=h2 href=# onclick=\"$('#add_block').show('slow');\">Добавление блока</a>.
