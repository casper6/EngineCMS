...
if ($func == "opengarbage") { // Открытие вкладок Содержания
  ...
  if ($id == 8) { // ПОМОЩЬ
    $pageslistdel .= "<p><a href=# onclick=\"$('#about_cms').show('slow');\">Что такое «ДвижОк»?</a>.
      ...
      <p><a href=# onclick=\"$('#osnova').show('slow');\">Ознакомиться с основными элементами</a>.
...
<p><a href=# onclick=\"$('#razdel').show('slow');\">Подробнее о разделах, папках и страницах</a>.
...
<p><a href=# onclick=\"$('#add_block').show('slow');\">Добавление блока</a>.
