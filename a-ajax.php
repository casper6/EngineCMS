...
if ($func == "opengarbage") { // Открытие вкладок Содержания
  ...
  if ($id == 10) {
    ...
    $pageslistdel .= "<p>Вы находитесь в Панели управления сайтом на Главной странице администрирования.<p><a class='h2 punkt' href=# onclick=\"$('#about_cms').toggle('slow');\">Что такое «ДвижОк»?</a>.
      ...
      <p><a class='h2 punkt' href=# onclick=\"$('#osnova').toggle('slow');\">Ознакомиться с основными элементами</a>.
...
<a class=punkt href=# onclick=\"$('#panel').toggle('slow');\">На ней могут быть...</a>
...
<p><a class='h2 punkt' href=# onclick=\"$('#razdel').toggle('slow');\">Подробнее о разделах, папках и страницах</a>.
...
<p><a class='h2 punkt' href=# onclick=\"$('#add_block').toggle('slow');\">Добавление блока</a>.
...
<p><a class='h2 punkt' href=# onclick=\"$('#add_link').toggle('slow');\">Добавление ссылки</a>.
...
<p><a class='h2 punkt' href=# onclick=\"$('#add_banner').toggle('slow');\">Добавление баннера</a>.
...
<p>— Жмем кнопку Блоки на главной администрирования — ищем в списке блоков нужный блок (к примеру: «Баннер_на_Главной», «верхний баннер» и т.д.)
...
<p>— Если на картинку нужно поставить ссылку на другой сайт или страницу нашего сайта — жмем по картинке и вписываем ссылку на сайт в поле Ссылка.
<p>— Сохраняем (кнопка Сохранить в левом верхнем углу).</div>

<p><i>За более подробной информацией обратитесь к разработчику (это поможет улучшить справочную систему).</i>
";
