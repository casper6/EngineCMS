...
$str2 .= " ".$arrres2[$i].","; // обязательно пробел в начале или strpos не сработает потом
	  ...
	  if (mb_strlen($str2) > 1) $keys = trim(mb_substr($str2, 0, -1)); // обьединяем словосочетания и слова
	  return $keys;
}
