...
function openbox(id,name) {
	var add = '';
	if (name == 'Помощь') add = '<a title="Закрыть" class="punkt" onclick="$(\'#podrazdel\').hide(\'slow\');"><div class="radius" style="font-size:12pt; width:20px; height: 20px; color: white; text-align:center; float:right; margin:5px; background: #bbbbbb;">&nbsp;x&nbsp;</div></a><p>Вы находитесь в Панели управления сайтом ';
