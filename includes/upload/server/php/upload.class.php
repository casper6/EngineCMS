...
class UploadHandler
{
    ...
    function __construct($options=null) {
        $this->options = array(
            ...
            'upload_dir' => $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR .'img/', // dirname($_SERVER['SCRIPT_FILENAME']).'/files/'
            'upload_url' => 'img/', // $this->getFullUrl().'/files/'
            'param_name' => 'files',
