...
$PHPTHUMB_CONFIG['cache_maxage'] = 20160 * 30;        // delete cached thumbnails that haven't been accessed in more than [7 days] (value is maximum time since last access in seconds to avoid deletion)
